...
if __name__ == "__main__":
    ...
    # Runs every input pattern (multiple AllReduce calls in a row -> exercises
    # slot reuse across calls). Prints PASS/FAIL per pattern for this rank.
    Test.test_allreduce(coll, args.rank, args.world, args.size)
